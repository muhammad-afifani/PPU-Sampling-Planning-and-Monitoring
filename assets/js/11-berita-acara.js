...
function ensureBaConfig(){
  ...
  ["emisi","ambient"].forEach(team=>{
    if(!DB.baConfig[team]) DB.baConfig[team] = {namaPhm:"", jabatanPhm:"", labPerusahaan:"PT Sucofindo", namaLab:"", jabatanLab:"Ketua Tim Pemantauan Emisi"};
  });
  return DB.baConfig;
}
...
["baTeam"].forEach(id=>document.getElementById(id).addEventListener("change", ()=>{
  ["baNamaPhm","baJabatanPhm","baNamaLabPerusahaan","baNamaLab","baJabatanLab","baTanggalPelaksanaan","baTempatTanggal"].forEach(f=>delete document.getElementById(f).dataset.touched);
...
["baNamaPhm","baJabatanPhm","baNamaLabPerusahaan","baNamaLab","baJabatanLab","baTanggalPelaksanaan","baTempatTanggal"].forEach(id=>{
  document.getElementById(id).addEventListener("input", e=>{
    e.target.dataset.touched = "1";
    const team = document.getElementById("baTeam").value;
    const cfg = ensureBaConfig();
    const map = {baNamaPhm:"namaPhm", baJabatanPhm:"jabatanPhm", baNamaLabPerusahaan:"labPerusahaan", baNamaLab:"namaLab", baJabatanLab:"jabatanLab"};
  ...
  return `<div class="pg-batch pg-ba">
    ...
    <table class="pg-ba-page">
      ...
      <tbody><tr><td>
        ...
        <div class="pg-ba-foot-note">*Akan dipantau ketika running hour memenuhi ambang wajib pantau Emergency Engine.</div>
      </td></tr></tbody>
    </table>
